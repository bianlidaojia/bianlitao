                   ...
                   <div style="margin-left:60px;float:left;" class="xiao-text">
                       <table>
                           <tr>
                            ...
                            <tr>
                                <td>商户地理位置</td>
                                <td>广东省深圳市南山区一路3001号<br>N:35`55`435&nbsp;E:45`66`908`<br><span>正常</span></td>
                            </tr>
                            <tr>
                                <td>小票金额</td>
                                <td>￥32.50</td>
              ...
              <div class="detail-tie">订单状态</div>
               <table class="xiao_state">  
                   ...
                   <tr>
                       ...
                       <td class="xiao_selected" style="padding:0px 20px;"><div>审核中</div><div>2017-03-26 12:45:46</div></td>
                   </tr>
               </table>
           </div>
       </div>
